...
class AmityProfileContainerViewController : UIViewController, UIScrollViewDelegate {
    ...
    weak var dataSource: AmityProfileDataSource!
    weak var delegate: AmityProfileProgressDelegate?
    ...
    private var bottomVC: (UIViewController & AmityProfilePagerAwareProtocol)!
...
//MARK: AmityProfileBottomPageDelegate
extension AmityProfileContainerViewController : AmityProfileBottomPageDelegate {
