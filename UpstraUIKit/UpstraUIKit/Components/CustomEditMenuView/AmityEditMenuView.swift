...
public class AmityEditMenuView {
    ...
    func generateMenuItems(messageType: AmityMessageType, indexPath: IndexPath?, text: String?, isOwner: Bool, isErrorMessage: Bool, isReported: Bool, isBoardcastMessage: Bool) -> [AmityEditMenuItem] {
        ...
        /** Case : Message **/
        // Add reply button if not boardcast message
        if !isBoardcastMessage {
