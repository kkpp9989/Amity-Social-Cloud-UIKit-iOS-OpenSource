//
//  PreviewImagePickerPostController.swift
//  AmityUIKit
//
//  Created by GuIDe'MacbookAmityHQ on 23/4/2567 BE.
...
class PreviewImagePickerPostController: AmityViewController {
    ...
    public static func make(media: [AmityMedia],
                            viewModel: AmityPostDetailScreenViewModelType,
                            mediaType: AmityMediaType,
                            title: String,
                            asset: [PHAsset]) -> PreviewImagePickerPostController {
        let vc = PreviewImagePickerPostController(nibName: PreviewImagePickerPostController.identifier, bundle: AmityUIKitManager.bundle)
        vc.imageList = media
...
extension PreviewImagePickerPostController: UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
