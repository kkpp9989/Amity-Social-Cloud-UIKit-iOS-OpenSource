//
//  GroupChatCreatorViewController.swift
//  AmityUIKit
//
...
class GroupChatCreatorViewController: AmityViewController {
    ...
    private init(_ selectUsersData: [AmitySelectMemberModel]) {
        ...
        super.init(nibName: GroupChatCreatorViewController.identifier, bundle: AmityUIKitManager.bundle)
    ...
    public static func make(_ selectUsersData: [AmitySelectMemberModel]) -> GroupChatCreatorViewController {
        return GroupChatCreatorViewController(selectUsersData)
    }
...
extension GroupChatCreatorViewController: UITextFieldDelegate {
...
extension GroupChatCreatorViewController: AmityTextViewDelegate {
...
extension GroupChatCreatorViewController: UIImagePickerControllerDelegate & UINavigationControllerDelegate {
