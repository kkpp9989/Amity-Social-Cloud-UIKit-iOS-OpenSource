//
//  AmityMemberPickerChatFirstViewController.swift
//  AmityUIKit
//
...
public final class AmityMemberPickerChatFirstViewController: AmityViewController {
...
private extension AmityMemberPickerChatFirstViewController {
	@objc func doneTap() {
		let selectUsersData = screenViewModel.dataSource.getStoreUsers()

		let vc = GroupChatCreatorSecondViewController.make(selectUsersData)
...
extension AmityMemberPickerChatFirstViewController: UISearchBarDelegate {
	public func searchBar(_ searchBar: UISearchBar, textDidChange searchText: String) {
		screenViewModel.action.searchUser(with: searchText)
	}
}

extension AmityMemberPickerChatFirstViewController: UITableViewDelegate {
...
extension AmityMemberPickerChatFirstViewController: UITableViewDataSource {
...
extension AmityMemberPickerChatFirstViewController: UICollectionViewDataSource {
...
extension AmityMemberPickerChatFirstViewController: UICollectionViewDelegateFlowLayout {
