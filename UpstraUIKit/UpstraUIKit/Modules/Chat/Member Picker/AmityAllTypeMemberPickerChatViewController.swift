//
//  AmityAllTypeMemberPickerChatViewController.swift
//  AmityUIKit
//
//  Created by Thanaphat Thanawatpanya on 12/12/2566 BE.
...
class AmityAllTypeMemberPickerChatViewController: AmityPageViewController {
    ...
    public static func make(withCurrentUsers users: [AmitySelectMemberModel] = [],
                            ...
                            displayName: String = "") -> AmityAllTypeMemberPickerChatViewController {
        ...
        let vc = AmityAllTypeMemberPickerChatViewController(nibName: AmityAllTypeMemberPickerChatViewController.identifier, bundle: AmityUIKitManager.bundle)
...
extension AmityAllTypeMemberPickerChatViewController: AmityMemberPickerChatScreenViewModelDelegate {
