...
class AmityMessageTableViewCell: UITableViewCell, AmityMessageCellProtocol {
    ...
    func display(message: AmityMessageModel) {
        ...
        containerView.menuItems = editMessageMenuView.generateMenuItems(messageType: message.messageType, indexPath: indexPath, text: message.text, isOwner: message.isOwner, isErrorMessage: false, isReported: message.flagCount > 0, isBoardcastMessage: channelType == .broadcast)
        ...
        if message.isDeleted {
            ...
            if message.isOwner {
                ...
                case .error:
                    ...
                    containerView.menuItems = editMessageMenuView.generateMenuItems(messageType: message.messageType, indexPath: indexPath, text: message.text, isOwner: message.isOwner, isErrorMessage: true, isReported: message.flagCount > 0, isBoardcastMessage: channelType == .broadcast)
                case .syncing:
