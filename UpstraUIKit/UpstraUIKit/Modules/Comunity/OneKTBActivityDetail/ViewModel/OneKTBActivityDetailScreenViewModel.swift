//
//  OneKTBActivityDetailScreenViewModel.swift
//  AmityUIKit
//
...
final class OneKTBActivityDetailScreenViewModel: OneKTBActivityDetailScreenViewModelType {
    
    weak var delegate: OneKTBActivityDetailScreenViewModelDelegate?
...
extension OneKTBActivityDetailScreenViewModel {
    ...
    private func prepareComponents(post: AmityPostModel) -> AmityPostComponent {
        ...
        return AmityPostComponent(component: AmityPostContentComponent(post: post))
    }
