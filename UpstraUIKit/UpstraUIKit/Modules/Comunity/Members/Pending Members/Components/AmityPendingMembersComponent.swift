//
//  AmityPendingMembersComponent.swift
//  AmityUIKit
//
...
struct AmityPendingMembersComponent: AmityPostComposable {
    ...
    func getComponentCell(_ tableView: UITableView, at indexPath: IndexPath) -> UITableViewCell {
        ...
        case .action:
            let cell: AmityPendingMembersActionTableViewCell = tableView.dequeueReusableCell(for: indexPath)
