//
//  AmityPendingMembersCommunityViewModel.swift
//  AmityUIKit
//
...
protocol AmityPendingMembersCommunityViewModelProtocol {
    func getMemberStatus(_ completion: ((AmityCommunityModel?, AmityMemberStatusCommunity) -> Void)?)
}

final class AmityPendingMembersCommunityViewModel: AmityPendingMembersCommunityViewModelProtocol {
